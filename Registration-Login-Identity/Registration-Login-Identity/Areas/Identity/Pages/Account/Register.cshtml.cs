...
namespace Registration_Login_Identity.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(IFormFile file ,string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser {FirstName=Input.FirstName,LastName=Input.LastName ,UserName = Input.Email, Email = Input.Email, ImagePath = file.FileName, Gender=Input.Gender };
